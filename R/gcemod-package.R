...
#' covariate-by-event-type interaction estimates \eqn{\log(\omega^{+}\text{
#' ratio})}. See \code{\link{lunnmcneil}}.
#'
...
#'   \item{\code{\link{gce_tidy}}}{Tidy coefficient tables.}
#' }
#'
#' @references
